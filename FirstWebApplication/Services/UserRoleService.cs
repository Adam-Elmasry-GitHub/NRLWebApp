...
namespace FirstWebApplication.Services
{
    ...
    public class UserRoleService
    {
        ...
        /// </summary>
        public virtual async Task<bool> CreateRoleAsync(string roleName)
        {
        ...
        /// </summary>
        public virtual async Task<bool> AssignRoleToUserAsync(string userEmail, string roleName)
        {
        ...
        /// </summary>
        public virtual async Task<bool> RemoveRoleFromUserAsync(string userEmail, string roleName)
        {
            var user = await _userManager.FindByEmailAsync(userEmail);
            if (user == null)
            {
        ...
        /// </summary>
        public virtual async Task<IList<string>> GetUserRolesAsync(string userEmail)
        {
            var user = await _userManager.FindByEmailAsync(userEmail);
            if (user == null)
            {
        ...
        /// </summary>
        public virtual async Task<bool> IsUserInRoleAsync(string userEmail, string roleName)
        {
            var user = await _userManager.FindByEmailAsync(userEmail);
            if (user == null)
            {
